...
CREATE FUNCTION floor(dec128) RETURNS dec128
        AS 'MODULE_PATHNAME', 'dec128floor'
       	LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION ceil(dec128) RETURNS dec128
        AS 'MODULE_PATHNAME', 'dec128ceil'
       	LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION abs(dec128) RETURNS dec128
        AS 'MODULE_PATHNAME', 'dec128abs'
       	LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION round(dec128, int) RETURNS dec128
        AS 'MODULE_PATHNAME', 'dec128round'
       	LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
